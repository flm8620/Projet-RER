...
bool NormalDistribution::isInitialized=false;
double NormalDistribution::T[300]={0};


NormalDistribution::NormalDistribution()
{
    if(isInitialized==false){
        std::cout<<"ini normal"<<std::endl;
...
double NormalDistribution::getPhi2(double x)
{
    int A;
    if(x>=0){
        A=int(x*100);
        ...
        A=-(int(x*100)-1);//-1 parce que on veut A=-1 si x*300=-0.5
        if(A>299)return 0.0;
        return 1-T[A];
    }
}
double NormalDistribution::getPhi1(double x)
{
